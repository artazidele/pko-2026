...
var chart_timeSpentSummaryChart_c277f = new Chart(document.getElementById('chart_timeSpentSummaryChart_c277f'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_c277f.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_c277f.resize();
});