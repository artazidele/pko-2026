...
var chart_timeSpentSummaryChart_5e572 = new Chart(document.getElementById('chart_timeSpentSummaryChart_5e572'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_5e572.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_5e572.resize();
});