...
var chart_moveEvaluationSpeedSummaryChart_8204b = new Chart(document.getElementById('chart_moveEvaluationSpeedSummaryChart_8204b'), {
    type: 'line',
    data: {
        datasets: [
            {
                ...
                }, 
{
                  ...
                  ,
                  data: [
                    {x: 61403894, y: 44082}, {x: 134837482, y: 32515}, {x: 216316539, y: 24347}, {x: 303250121, y: 16106}, {x: 394322151, y: 12750}
                  ]
                }, 
{
...
window.addEventListener('beforeprint', () => {
  chart_moveEvaluationSpeedSummaryChart_8204b.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_moveEvaluationSpeedSummaryChart_8204b.resize();
});
