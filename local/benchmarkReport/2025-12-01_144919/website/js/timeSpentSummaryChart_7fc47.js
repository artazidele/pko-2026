...
var chart_timeSpentSummaryChart_7fc47 = new Chart(document.getElementById('chart_timeSpentSummaryChart_7fc47'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_7fc47.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_7fc47.resize();
});