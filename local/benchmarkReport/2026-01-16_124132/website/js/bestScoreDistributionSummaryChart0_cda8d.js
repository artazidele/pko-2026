...
var chart_bestScoreDistributionSummaryChart0_cda8d = new Chart(document.getElementById('chart_bestScoreDistributionSummaryChart0_cda8d'), {
    type: 'boxplot',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreDistributionSummaryChart0_cda8d.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreDistributionSummaryChart0_cda8d.resize();
});