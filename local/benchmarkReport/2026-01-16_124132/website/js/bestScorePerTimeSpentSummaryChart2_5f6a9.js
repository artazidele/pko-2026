...
var chart_bestScorePerTimeSpentSummaryChart2_5f6a9 = new Chart(document.getElementById('chart_bestScorePerTimeSpentSummaryChart2_5f6a9'), {
    type: 'line',
    data: {
        datasets: [
            {
...
window.addEventListener('beforeprint', () => {
  chart_bestScorePerTimeSpentSummaryChart2_5f6a9.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScorePerTimeSpentSummaryChart2_5f6a9.resize();
});
