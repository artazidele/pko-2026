...
var chart_bestScoreSummaryChart0_e8de = new Chart(document.getElementById('chart_bestScoreSummaryChart0_e8de'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart0_e8de.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart0_e8de.resize();
});