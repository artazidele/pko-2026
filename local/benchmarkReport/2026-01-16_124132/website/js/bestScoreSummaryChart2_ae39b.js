...
var chart_bestScoreSummaryChart2_ae39b = new Chart(document.getElementById('chart_bestScoreSummaryChart2_ae39b'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart2_ae39b.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart2_ae39b.resize();
});