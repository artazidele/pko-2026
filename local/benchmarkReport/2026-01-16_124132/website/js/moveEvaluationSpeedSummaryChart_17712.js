...
var chart_moveEvaluationSpeedSummaryChart_17712 = new Chart(document.getElementById('chart_moveEvaluationSpeedSummaryChart_17712'), {
    type: 'line',
    data: {
        datasets: [
            {
...
,
                  data: [
                    {x: 78761812, y: 21074}, {x: 164632584, y: 14424}, {x: 259200590, y: 10484}, {x: 359743372, y: 7651}, {x: 464848945, y: 6741}
                  ]
                }, 
{
...
,
                  data: [
                    {x: 78761812, y: 19177}, {x: 164632584, y: 14156}, {x: 259200590, y: 10459}, {x: 359743372, y: 8436}, {x: 464848945, y: 7024}
                  ]
                }, 
{
...
,
                  data: [
                    {x: 78761812, y: 20059}, {x: 164632584, y: 14250}, {x: 259200590, y: 10567}, {x: 359743372, y: 8456}, {x: 464848945, y: 7234}
                  ]
                }
        ]
    },
...
window.addEventListener('beforeprint', () => {
  chart_moveEvaluationSpeedSummaryChart_17712.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_moveEvaluationSpeedSummaryChart_17712.resize();
});
