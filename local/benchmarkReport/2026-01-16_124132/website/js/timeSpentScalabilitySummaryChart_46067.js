...
var chart_timeSpentScalabilitySummaryChart_46067 = new Chart(document.getElementById('chart_timeSpentScalabilitySummaryChart_46067'), {
    type: 'line',
    data: {
        datasets: [
            {
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentScalabilitySummaryChart_46067.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentScalabilitySummaryChart_46067.resize();
});
