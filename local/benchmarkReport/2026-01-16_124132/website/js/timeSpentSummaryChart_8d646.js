...
var chart_timeSpentSummaryChart_8d646 = new Chart(document.getElementById('chart_timeSpentSummaryChart_8d646'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_8d646.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_8d646.resize();
});