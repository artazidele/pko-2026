...
var chart_winningScoreDifferenceSummaryChart0_b9ee = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart0_b9ee'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart0_b9ee.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart0_b9ee.resize();
});