...
var chart_winningScoreDifferenceSummaryChart1_5f87b = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart1_5f87b'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart1_5f87b.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart1_5f87b.resize();
});