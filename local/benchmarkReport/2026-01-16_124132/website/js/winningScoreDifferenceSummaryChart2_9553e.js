...
var chart_winningScoreDifferenceSummaryChart2_9553e = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart2_9553e'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart2_9553e.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart2_9553e.resize();
});