...
var chart_worstScoreDifferencePercentageSummaryChart0_69f7e = new Chart(document.getElementById('chart_worstScoreDifferencePercentageSummaryChart0_69f7e'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_69f7e.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_69f7e.resize();
});