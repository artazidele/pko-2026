...
var chart_worstScoreDifferencePercentageSummaryChart1_32bee = new Chart(document.getElementById('chart_worstScoreDifferencePercentageSummaryChart1_32bee'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart1_32bee.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart1_32bee.resize();
});