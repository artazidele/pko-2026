...
var chart_bestScoreDistributionSummaryChart0_37c7d = new Chart(document.getElementById('chart_bestScoreDistributionSummaryChart0_37c7d'), {
    type: 'boxplot',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreDistributionSummaryChart0_37c7d.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreDistributionSummaryChart0_37c7d.resize();
});