...
var chart_bestScoreDistributionSummaryChart2_57644 = new Chart(document.getElementById('chart_bestScoreDistributionSummaryChart2_57644'), {
    type: 'boxplot',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreDistributionSummaryChart2_57644.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreDistributionSummaryChart2_57644.resize();
});