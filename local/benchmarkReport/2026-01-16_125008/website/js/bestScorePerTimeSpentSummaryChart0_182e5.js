...
var chart_bestScorePerTimeSpentSummaryChart0_182e5 = new Chart(document.getElementById('chart_bestScorePerTimeSpentSummaryChart0_182e5'), {
    type: 'line',
    data: {
        datasets: [
            {
...
,
                  data: [
                    {x: 10000, y: -400000}, {x: 10001, y: -2000000}
                  ]
                }, 
{
...
window.addEventListener('beforeprint', () => {
  chart_bestScorePerTimeSpentSummaryChart0_182e5.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScorePerTimeSpentSummaryChart0_182e5.resize();
});
