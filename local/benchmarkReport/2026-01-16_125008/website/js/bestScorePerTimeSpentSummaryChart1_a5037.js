...
var chart_bestScorePerTimeSpentSummaryChart1_a5037 = new Chart(document.getElementById('chart_bestScorePerTimeSpentSummaryChart1_a5037'), {
    type: 'line',
    data: {
        datasets: [
            {
...
window.addEventListener('beforeprint', () => {
  chart_bestScorePerTimeSpentSummaryChart1_a5037.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScorePerTimeSpentSummaryChart1_a5037.resize();
});
