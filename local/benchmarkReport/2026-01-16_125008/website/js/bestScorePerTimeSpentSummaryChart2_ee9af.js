...
var chart_bestScorePerTimeSpentSummaryChart2_ee9af = new Chart(document.getElementById('chart_bestScorePerTimeSpentSummaryChart2_ee9af'), {
    type: 'line',
    data: {
        datasets: [
            {
...
,
                  data: [
                    {x: 10000, y: -120000}, {x: 10001, y: -480000}
                  ]
                }, 
{
...
window.addEventListener('beforeprint', () => {
  chart_bestScorePerTimeSpentSummaryChart2_ee9af.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScorePerTimeSpentSummaryChart2_ee9af.resize();
});
