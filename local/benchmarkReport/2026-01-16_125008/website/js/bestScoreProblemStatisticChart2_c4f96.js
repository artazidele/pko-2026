...
var chart_bestScoreProblemStatisticChart2_c4f96 = new Chart(document.getElementById('chart_bestScoreProblemStatisticChart2_c4f96'), {
    type: 'line',
    data: {
        datasets: [
            {
...
,
                  data: [
                    {x: 113, y: -120000}, {x: 10000, y: -120000}
                  ]
                }, 
{
...
,
                  data: [
                    {x: 55, y: -120000}, {x: 10000, y: -120000}
                  ]
                }, 
{
...
,
                  data: [
                    {x: 65, y: -120000}, {x: 10000, y: -120000}
                  ]
                }, 
{
...
,
                  data: [
                    {x: 54, y: -120000}, {x: 10000, y: -120000}
                  ]
                }, 
{
...
,
                  data: [
                    {x: 53, y: -120000}, {x: 10000, y: -120000}
                  ]
                }, 
{
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreProblemStatisticChart2_c4f96.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreProblemStatisticChart2_c4f96.resize();
});
