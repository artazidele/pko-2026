...
var chart_bestScoreScalabilitySummaryChart0_e0b87 = new Chart(document.getElementById('chart_bestScoreScalabilitySummaryChart0_e0b87'), {
    type: 'line',
    data: {
        datasets: [
            {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreScalabilitySummaryChart0_e0b87.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreScalabilitySummaryChart0_e0b87.resize();
});
