...
var chart_bestScoreScalabilitySummaryChart1_5ba03 = new Chart(document.getElementById('chart_bestScoreScalabilitySummaryChart1_5ba03'), {
    type: 'line',
    data: {
        datasets: [
            {
...
,
                  data: [
                    {x: 78761812, y: 0}, {x: 164632584, y: -11185}, {x: 259200590, y: -83714}, {x: 359743372, y: -160731}, {x: 464848945, y: -254743}
                  ]
                }, 
{
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreScalabilitySummaryChart1_5ba03.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreScalabilitySummaryChart1_5ba03.resize();
});
