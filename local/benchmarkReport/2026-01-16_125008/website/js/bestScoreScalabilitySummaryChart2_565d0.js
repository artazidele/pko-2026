...
var chart_bestScoreScalabilitySummaryChart2_565d0 = new Chart(document.getElementById('chart_bestScoreScalabilitySummaryChart2_565d0'), {
    type: 'line',
    data: {
        datasets: [
            {
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreScalabilitySummaryChart2_565d0.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreScalabilitySummaryChart2_565d0.resize();
});
