...
var chart_bestScoreSummaryChart0_88c1f = new Chart(document.getElementById('chart_bestScoreSummaryChart0_88c1f'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart0_88c1f.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart0_88c1f.resize();
});