...
var chart_bestScoreSummaryChart1_c0d73 = new Chart(document.getElementById('chart_bestScoreSummaryChart1_c0d73'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart1_c0d73.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart1_c0d73.resize();
});