...
var chart_bestScoreSummaryChart2_4a02e = new Chart(document.getElementById('chart_bestScoreSummaryChart2_4a02e'), {
    type: 'bar',
    data: {
        labels: [
...
,
                  data: [
                    -120000, -210000, -300000, -390000, -480000
                  ]
                }, 
{
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart2_4a02e.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart2_4a02e.resize();
});