...
var chart_timeSpentScalabilitySummaryChart_19f84 = new Chart(document.getElementById('chart_timeSpentScalabilitySummaryChart_19f84'), {
    type: 'line',
    data: {
        datasets: [
            {
...
,
                  data: [
                    {x: 78761812, y: 10000}, {x: 464848945, y: 10000}
                  ]
                }, 
{
...
,
                  data: [
                    {x: 78761812, y: 10000}, {x: 359743372, y: 10000}, {x: 464848945, y: 10001}
                  ]
                }, 
{
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentScalabilitySummaryChart_19f84.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentScalabilitySummaryChart_19f84.resize();
});
