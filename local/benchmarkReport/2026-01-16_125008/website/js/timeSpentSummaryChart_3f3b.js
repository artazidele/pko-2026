...
var chart_timeSpentSummaryChart_3f3b = new Chart(document.getElementById('chart_timeSpentSummaryChart_3f3b'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_3f3b.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_3f3b.resize();
});