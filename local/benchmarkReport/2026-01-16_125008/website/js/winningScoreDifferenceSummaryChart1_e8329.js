...
var chart_winningScoreDifferenceSummaryChart1_e8329 = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart1_e8329'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart1_e8329.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart1_e8329.resize();
});