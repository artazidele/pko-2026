...
var chart_winningScoreDifferenceSummaryChart2_92e8f = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart2_92e8f'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart2_92e8f.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart2_92e8f.resize();
});