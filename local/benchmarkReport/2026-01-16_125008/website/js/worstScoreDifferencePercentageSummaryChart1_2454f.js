...
var chart_worstScoreDifferencePercentageSummaryChart1_2454f = new Chart(document.getElementById('chart_worstScoreDifferencePercentageSummaryChart1_2454f'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart1_2454f.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart1_2454f.resize();
});