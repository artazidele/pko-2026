...
var chart_moveEvaluationSpeedSummaryChart_eadf3 = new Chart(document.getElementById('chart_moveEvaluationSpeedSummaryChart_eadf3'), {
    type: 'line',
    data: {
        datasets: [
            {
...
window.addEventListener('beforeprint', () => {
  chart_moveEvaluationSpeedSummaryChart_eadf3.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_moveEvaluationSpeedSummaryChart_eadf3.resize();
});
