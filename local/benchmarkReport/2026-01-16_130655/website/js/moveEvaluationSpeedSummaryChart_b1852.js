...
var chart_moveEvaluationSpeedSummaryChart_b1852 = new Chart(document.getElementById('chart_moveEvaluationSpeedSummaryChart_b1852'), {
    type: 'line',
    data: {
        datasets: [
            {
                ...
                }, 
{
                  ...
                  ,
                  data: [
                    {x: 78761812, y: 16915}, {x: 164632584, y: 12905}, {x: 259200590, y: 10196}
                  ]
                }, 
{
                ...
                }, 
{
                  ...
                  ,
                  data: [
                    {x: 78761812, y: 18866}, {x: 164632584, y: 12945}, {x: 259200590, y: 9756}
                  ]
                }, 
{
                ...
                }, 
{
                  ...
                  ,
                  data: [
                    {x: 78761812, y: 18722}, {x: 164632584, y: 12826}
                  ]
                }
        ]
    },
...
window.addEventListener('beforeprint', () => {
  chart_moveEvaluationSpeedSummaryChart_b1852.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_moveEvaluationSpeedSummaryChart_b1852.resize();
});
