...
var chart_timeSpentSummaryChart_48cb = new Chart(document.getElementById('chart_timeSpentSummaryChart_48cb'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_48cb.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_48cb.resize();
});