...
var chart_timeSpentSummaryChart_27049 = new Chart(document.getElementById('chart_timeSpentSummaryChart_27049'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_27049.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_27049.resize();
});